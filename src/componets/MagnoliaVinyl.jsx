        ...
        <section className="panel" style={style.panel}>
            ...
            <div style={style.content}>
                ...
                <Row className="justify-content-center gap-2" style={{ marginTop: 40 }}>
                    ...
                    <Col xs="auto">
                        <Button style={style.button} onClick={() => window.open("https://projectmili.store/products/ender-magnolia-original-soundtrack-vinyl-record", "_blank", "noopener,noreferrer")}>
                            PURCHASE
                        </Button>
                    </Col>
                </Row>
